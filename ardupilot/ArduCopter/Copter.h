 ...
 */
#ifndef __ArduCopter_Copter_h__
#define __ArduCopter_Copter_h__
...
private:
    ...
    // Optical flow sensor
#if OPTFLOW == ENABLED
    OpticalFlow optflow{ahrs, serial_manager};
#endif
