...
bool AP_InertialSensor_PX4::_init_sensor(void) 
{
    ...
    _accel_fd[0] = 0; //open(ACCEL_BASE_DEVICE_PATH "0", O_RDONLY);
    _accel_fd[1] =  0; //open(ACCEL_BASE_DEVICE_PATH "1", O_RDONLY);
    _accel_fd[2] =  0; //open(ACCEL_BASE_DEVICE_PATH "2", O_RDONLY);
    _gyro_fd[0] =  0; //open(GYRO_BASE_DEVICE_PATH "0", O_RDONLY);
    _gyro_fd[1] =  0; //open(GYRO_BASE_DEVICE_PATH "1", O_RDONLY);
    _gyro_fd[2] =  0; //open(GYRO_BASE_DEVICE_PATH "2", O_RDONLY);
