#ifndef __AP_HAL_UARTDriver_h__
#define __AP_HAL_UARTDriver_h__
...
public:
    ...
    void printArray(uint8_t *buf, int len, const char *desc);

    void logWave(void *buf, int len);
};

#endif /* __AP_HAL_UARTDriver_h__ */
