 ...
 */
#ifndef __AP_OpticalFlow_OpticalFlow_h__
#define __AP_OpticalFlow_OpticalFlow_h__
...
public:
    // constructor
    OpticalFlow(AP_AHRS_NavEKF& ahrs, AP_SerialManager &serialManager);
...
#endif /* __AP_OpticalFlow_OpticalFlow_h__ */
