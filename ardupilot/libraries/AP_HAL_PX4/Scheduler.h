...
#define APM_MAIN_PRIORITY_BOOST (RT_THREAD_PRIORITY_MAX - 241)
#define APM_MAIN_PRIORITY       (RT_THREAD_PRIORITY_MAX - 180)
#define APM_TIMER_PRIORITY      (RT_THREAD_PRIORITY_MAX - 181)
#define APM_SPI_PRIORITY        (RT_THREAD_PRIORITY_MAX - 242)
#define APM_CAN_PRIORITY        (RT_THREAD_PRIORITY_MAX - 179)
#define APM_I2C_PRIORITY        (RT_THREAD_PRIORITY_MAX - 178)
#define APM_UART_PRIORITY       (RT_THREAD_PRIORITY_MAX -  60)
#define APM_STORAGE_PRIORITY    (RT_THREAD_PRIORITY_MAX -  59)
#define APM_IO_PRIORITY         (RT_THREAD_PRIORITY_MAX -  58)
#define APM_SHELL_PRIORITY      (RT_THREAD_PRIORITY_MAX -  57)
#define APM_OVERTIME_PRIORITY   (RT_THREAD_PRIORITY_MAX -  10)
#define APM_STARTUP_PRIORITY    (RT_THREAD_PRIORITY_MAX -  10)
