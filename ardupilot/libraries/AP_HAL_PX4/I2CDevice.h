 ...
 */
#ifndef __AP_HAL_PX4_I2CDevice_h__
#define __AP_HAL_PX4_I2CDevice_h__
...
public:
    ...
    static uint8_t map_bus_number(uint8_t bus);
...
private:
    ...
    uint8_t _busnum;
    struct rt_i2c_bus_device *_i2cdev;
    uint8_t _address;
    perf_counter_t perf;
    char _devname[32];
    char _busname[32];
...
#endif /* __AP_HAL_PX4_I2CDevice_h__ */
