#ifndef ____mavlink_msg_set_position_target_global_int_h__
#define ____mavlink_msg_set_position_target_global_int_h__
...
#endif /* ____mavlink_msg_set_position_target_global_int_h__ */